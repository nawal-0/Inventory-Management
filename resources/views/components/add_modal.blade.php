 ...
 <!-- Modal button -->
 <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="bg-primary font-medium text-sm text-white px-4 py-2 rounded-lg hover:bg-primary-dark">
    Add Item
</button>
                ...
                @csrf
                  <div class="grid gap-4 mb-4 grid-cols-2">
                      ...
                      <div class="col-span-2">
                        ...
                        <textarea name="description" id="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Write description here"></textarea>                    
                    </div>
